...
url_list = [
    ...
    url(r'^anime/user/note/$', views.UserAnimeNoteListView.as_view(), name='useranime_notelist'),
    url(r'^anime/statics/$', views.UserAnimeStaticsView.as_view(), name='useranime_statics'),
